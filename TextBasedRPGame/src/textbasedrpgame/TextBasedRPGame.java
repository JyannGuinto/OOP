 ...
 * @author Jyann 2
 */
class IntroScene implements GameScene 
{
...
class EndScene implements GameScene {
    public void playScene() {
...
public class TextBasedRPGame {
    ...
    int rescue;
    int completion=0;
    GameScene intro = new IntroScene();
    GameScene battle = new BattleScene();
    GameScene end = new EndScene();
